...
export const PROJECTS: Project[] = [
  {
    ...
    titleAr: 'صالون القصر الكلاسيكي الملكي - لوران',
  ...
  },
  {
    ...
    titleAr: 'ردهة استقبال الفيلات الفاخرة - كفر عبده',
    category: 'buildings',
    categoryAr: 'مبانٍ',
  ...
  },
  {
    ...
    titleAr: 'جناح غرفة النوم الرئيسية المودرن - جناكليس',
    category: 'residential',
    categoryAr: 'سكني',
  ...
  },
  {
    ...
    titleAr: 'شقة سكنية بتجاليد خشبية عصرية - سيتي لايت',
    category: 'residential',
    categoryAr: 'سكني',
    location: 'City Light, Alexandria',
    locationAr: 'سيتي لايت، الإسكندرية',
    area: 240,
    year: '2024',
  ...
  },
  {
    ...
    titleAr: 'شقة سكنية فاخرة - سبورتنج',
    category: 'residential',
    categoryAr: 'سكني',
  ...
  },
  {
    ...
    titleAr: 'أعمال التأسيسات الصحية والسباكة - المنتزه',
    category: 'buildings',
    categoryAr: 'مبانٍ',
    location: 'El Montazah, Alexandria',
    locationAr: 'المنتزه، الإسكندرية',
    area: 180,
    year: '2025',
  ...
  },
  {
    ...
    titleAr: 'جناح سكني متكامل التشطيبات الفاخرة - صواري',
    category: 'residential',
    categoryAr: 'سكني',
    location: 'Sawary, Alexandria',
    locationAr: 'صواري، الإسكندرية',
    area: 280,
    year: '2025',
  ...
  },
  {
    ...
    titleAr: 'شقة تشطيب الباقة الاقتصادية المتميزة - لوران',
    category: 'residential',
    categoryAr: 'سكني',
    location: 'Loran, Alexandria',
    locationAr: 'لوران، الإسكندرية',
  ...
  },
  {
    ...
    titleAr: 'فيلا ساحلية مودرن بواجهات زجاجية - المنتزه',
    category: 'residential',
    categoryAr: 'سكني',
    location: 'El Montazah, Alexandria',
    locationAr: 'المنتزه، الإسكندرية',
  ...
  },
  {
    ...
    titleAr: 'معرض الأجهزة والتجهيزات التجارية - سيتي لايت',
    category: 'commercial',
    categoryAr: 'تجاري',
    location: 'City Light, Alexandria',
    locationAr: 'سيتي لايت، الإسكندرية',
  ...
  },
  {
    ...
    titleAr: 'مشروع الأسقف المعلقة والإضاءات - جناكليس',
    category: 'buildings',
    categoryAr: 'مبانٍ',
    location: 'Ginaklis, Alexandria',
    locationAr: 'جناكليس، الإسكندرية',
  ...
  },
  {
    ...
    titleAr: 'شقة سكنية ذكية بتشطيب الملوك - كفر عبده',
    category: 'residential',
    categoryAr: 'سكني',
    location: 'Kafr El Abdo, Alexandria',
    locationAr: 'كفر عبده، الإسكندرية',
